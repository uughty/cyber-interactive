    ...
    >
      ...
      <div className="relative z-10">
        ...
        <motion.div {...fadeUp()} className="text-center mb-20">
          ...
          >
            Interactive Defense,{" "}
            <span style={{ color: "#F97316" }}>Proactive Security</span>
          </h2>
        ...
        >
          <div style={{ height: 3, background: "linear-gradient(90deg, #F97316, #FFFFFF, transparent)" }} />
          <div
            style={{
              position: "absolute",
              inset: 0,
              background: "radial-gradient(ellipse at center top, rgba(249,115,22,0.06), transparent 60%)",
              pointerEvents: "none",
            }}
          />
          ...
          <div style={{ padding: "3rem 2rem", position: "relative", zIndex: 1 }}>
            ...
            <h3 className="text-3xl md:text-4xl font-extrabold mb-4" style={{ color: "#FBF9F9" }}>
              Your Defense{" "}
              <span style={{ color: "#F97316" }}>Never Sleeps</span>
            </h3>
    ...
    >
      ...
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: `radial-gradient(ellipse at top left, ${item.glow}, transparent 60%)`,
          pointerEvents: "none",
        }}
      />
      ...
      >
        ...
        <h3 className="text-2xl font-bold mb-3" style={{ color: "#FBF9F9" }}>
          {item.title}
        </h3>
        <div style={{ height: "0.5px", background: item.border, marginBottom: "1rem" }} />
        <p style={{ color: "#9CA3AF", fontSize: "0.9rem", lineHeight: 1.7, marginTop: "auto" }}>
          {item.desc}
        </p>
      </div>
    </motion.div>
