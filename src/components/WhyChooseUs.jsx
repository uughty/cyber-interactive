...
const reasons = [
  ...
  },
  {
    ...
    description: "Successfully protected 500+ organizations from cyber threats with zero major security incidents.",
    stats: "500+ Clients Protected",
    accent: "#00B6D5",
    border: "rgba(0,182,213,0.25)",
    glow: "rgba(0,182,213,0.08)",
    num: "03",
...
const WhyChooseUs = () => {
  return (
    ...
    >
      ...
      {/* Ambient glows */}
      <div className="absolute pointer-events-none" style={{ width: 560, height: 560, borderRadius: "50%", background: "radial-gradient(circle, rgba(0,182,213,0.07) 0%, transparent 70%)", top: -140, right: -100 }} />
      <div className="absolute pointer-events-none" style={{ width: 400, height: 400, borderRadius: "50%", background: "radial-gradient(circle, rgba(133,196,65,0.05) 0%, transparent 70%)", bottom: 0, left: 0 }} />
      ...
      <div className="relative z-10 container mx-auto max-w-7xl">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-6xl font-extrabold mb-5" style={{ color: "#FBF9F9", lineHeight: 1.15 }}>
            Why Choose{" "}
            <span style={{ color: "#00B6D5" }}>Cybertrove Africa</span>
          </h2>

          <p className="text-lg max-w-3xl mx-auto" style={{ color: "#6D7482", lineHeight: 1.75 }}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {reasons.map((reason, index) => {
            ...
            return (
              ...
              >
                {/* Top accent bar */}
                <div style={{ height: 3, background: `linear-gradient(90deg, ${reason.accent}, transparent)`, flexShrink: 0 }} />

                {/* Card glow */}
                <div style={{ position: "absolute", inset: 0, background: `radial-gradient(ellipse at top left, ${reason.glow}, transparent 60%)`, pointerEvents: "none" }} />

                <div style={{ padding: "1.75rem 2rem 2rem", position: "relative", zIndex: 1, flex: 1, display: "flex", flexDirection: "column" }}>

                  {/* Number + Icon row */}
                  <div className="flex items-center justify-between mb-5">
                    <span style={{ fontSize: "2rem", fontWeight: 800, color: reason.accent, opacity: 0.18, lineHeight: 1, letterSpacing: "-0.05em" }}>
                      {reason.num}
                    </span>
                    <div style={{
                  ...
                  >
                    <span style={{ fontSize: "0.72rem", fontWeight: 700, color: reason.accent, letterSpacing: "0.05em" }}>
                      {reason.stats}
                    </span>
                  </div>
                  ...
                  {/* Description */}
                  <p style={{ color: "#9aa3b0", lineHeight: 1.7, fontSize: "0.9rem", marginTop: "auto" }}>
                    {reason.description}
                  </p>
                </div>
              </div>
