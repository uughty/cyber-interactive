...
const Philosophy = () => {
  return (
    <section
      id="about"
      className="relative font-sans antialiased overflow-hidden py-28"
    ...
    >
      ...
      {/* Ambient glows */}
      <div className="absolute pointer-events-none z-0" style={{ width: 560, height: 560, borderRadius: "50%", background: "radial-gradient(circle, rgba(0,182,213,0.07) 0%, transparent 70%)", top: -120, left: -100 }} />
      <div className="absolute pointer-events-none z-0" style={{ width: 400, height: 400, borderRadius: "50%", background: "radial-gradient(circle, rgba(133,196,65,0.05) 0%, transparent 70%)", bottom: 0, right: 0 }} />
      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        <motion.div {...fadeUp()} className="text-center mb-24">
          ...
          >
            Rooted in{" "}
            <span style={{ color: "#00B6D5" }}>Cyber Excellence</span>
          </h2>
        </motion.div>
              ...
              >
                ...
                <div className="flex justify-center" style={{ direction: "ltr" }}>
                  <div style={{ position: "relative" }}>
                    ...
                    <div style={{ position: "absolute", top: -10, right: -10, width: 32, height: 32, borderRadius: "50%", background: "#0b1120", border: `0.5px solid ${section.border}`, display: "flex", alignItems: "center", justifyContent: "center", zIndex: 2 }}>
                    ...
                    <div style={{ width: 160, height: 160, borderRadius: "50%", background: "rgba(17,25,40,0.85)", border: `0.5px solid ${section.border}`, backdropFilter: "blur(14px)", display: "flex", alignItems: "center", justifyContent: "center", position: "relative", zIndex: 1, boxShadow: `0 0 0 1px ${section.border}, 0 0 40px ${section.glow}` }}>
                      ...
                      <img src={section.icon} alt={section.title} style={{ width: 72, height: 72, objectFit: "contain", position: "relative", zIndex: 1 }} />
                    </div>
                ...
                {/* ── Content card ── */}
                <div
                  style={{ direction: "ltr", background: "rgba(17,25,40,0.75)", border: `0.5px solid ${section.border}`, borderRadius: 16, overflow: "hidden", backdropFilter: "blur(14px)", position: "relative", transition: "transform 0.28s ease, box-shadow 0.28s ease" }}
                  onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-6px)"; e.currentTarget.style.boxShadow = `0 24px 56px ${section.glow}`; }}
                    ...
                    <ul className="space-y-5">
                      {section.points.map((point, idx) => (
                        <li key={idx} className="flex items-start gap-3">
                          <span style={{ width: 20, height: 20, borderRadius: 6, flexShrink: 0, marginTop: 2, background: section.glow, border: `0.5px solid ${section.border}`, display: "flex", alignItems: "center", justifyContent: "center" }}>
                            <svg width="9" height="9" viewBox="0 0 10 10" fill="none">
                              <path d="M2 5L4.5 7.5L8 2.5" stroke={section.accent} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                          </span>
                          <p style={{ color: "#9aa3b0", lineHeight: 1.7, fontSize: "0.95rem" }}>
