  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='120' height='120' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M 0 60 L 60 60 L 60 0' stroke='%23f7931e' stroke-width='0.3' fill='none'/%3E%3Cpath d='M 60 120 L 60 60 L 120 60' stroke='%23f7931e' stroke-width='0.3' fill='none'/%3E%3Ccircle cx='60' cy='60' r='1.5' fill='%23ffffff'/%3E%3C/svg%3E")`,
      ...
      {/* Ambient glows */}
      <div className="absolute pointer-events-none z-0" style={{ width: 560, height: 560, borderRadius: "50%", background: "radial-gradient(circle, rgba(247,147,30,0.07) 0%, transparent 70%)", top: -120, right: -80 }} />
      <div className="absolute pointer-events-none z-0" style={{ width: 400, height: 400, borderRadius: "50%", background: "radial-gradient(circle, rgba(255,255,255,0.05) 0%, transparent 70%)", bottom: 0, left: 0 }} />
      ...
      <section className="relative z-10 py-28 px-6 md:px-12">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-6xl font-extrabold mb-6" style={{ color: "#FFFFFF", lineHeight: 1.15 }}>
            Our <span style={{ color: "#f7931e" }}>Value Proposition</span>
          </h2>


          <p className="text-lg leading-relaxed max-w-3xl mx-auto" style={{ color: "#c6cbd3" }}>
            At{" "}
            <span style={{ fontWeight: 600, color: "#ffffff" }}>CyberTrove Africa</span>
            , we believe in a digital world where{" "}
            <span style={{ fontWeight: 600, color: "#f7931e" }}>security</span> is
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "1.75rem 2rem 2rem", position: "relative", zIndex: 1, flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        {/* Description */}
        <p style={{ color: "#c6cbd3", lineHeight: 1.7, fontSize: "0.9rem" }}>
          {prop.description}
        </p>
      </div>
    </div>
